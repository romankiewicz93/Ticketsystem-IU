<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        <header class="text-center">
            ...
            <p class="mb-4">Bearbeiten: {{$listing->title}}</p>
        </header>
        ...
        <form method="POST" action="/listings/{{$listing->id}}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title"
                    placeholder="Beispiel: Qualität schlecht" value="{{$listing->title}}"/>
            ...
            <div class="mb-6">
                <label for="location" class="inline-block text-lg mb-2">Ort</label>
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="location"
                    placeholder="Beispiel: Skript, Shortcast" value="{{$listing->location}}"/>
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags"
                    placeholder="Beispiel" value="{{$listing->tags}}"/>
